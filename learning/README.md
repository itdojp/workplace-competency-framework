...
[work-designs.csv](work-designs.csv)は36件の設計台帳であり、36教材の完成一覧ではありません。台帳の制作状態と上表を併読してください。開始文の自動生成はまだありません。[共通指導仕様](../coaches/common/instructions.md)を改訂する場合は両開始文への反映・版更新・再試験を同じPRで扱います。
